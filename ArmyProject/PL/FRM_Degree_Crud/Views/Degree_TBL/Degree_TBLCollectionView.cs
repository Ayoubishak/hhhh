...
namespace ArmyProject.PL.FRM_Degree_Crud.Views.Degree_TBLCollectionView{
    public partial class Degree_TBLCollectionView : XtraUserControl {
        public Degree_TBLCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<ArmyProject.PL.FRM_Degree_Crud.ViewModels.Degree_TBLCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as ArmyProject.Degree_TBL,
