namespace ArmyProject.PL.FRM_Degree_Crud.Views.Degree_TBLView {
    partial class Degree_TBLView {
		...
		private void InitializeComponent() {
            ...
            this.mainRibbonPageGroup.Text = "Degree_TBL Tasks";
			// 
			...
			this.dataLayoutControl1.DataSource = degree_TBLViewBindingSource;
			//
			//Create GridControls
			//
            ...
            this.mvvmContext.ViewModelType = typeof(ArmyProject.PL.FRM_Degree_Crud.ViewModels.Degree_TBLViewModel);
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(ArmyProject.PL.FRM_Degree_Crud.ViewModels.Degree_TBLViewModel), "Save", bbiSave));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(ArmyProject.PL.FRM_Degree_Crud.ViewModels.Degree_TBLViewModel), "SaveAndClose", bbiSaveAndClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(ArmyProject.PL.FRM_Degree_Crud.ViewModels.Degree_TBLViewModel), "SaveAndNew", bbiSaveAndNew));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(ArmyProject.PL.FRM_Degree_Crud.ViewModels.Degree_TBLViewModel), "Reset", bbiReset));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(ArmyProject.PL.FRM_Degree_Crud.ViewModels.Degree_TBLViewModel), "Delete", bbiDelete));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(ArmyProject.PL.FRM_Degree_Crud.ViewModels.Degree_TBLViewModel), "Close", bbiClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(ArmyProject.PL.FRM_Degree_Crud.ViewModels.Degree_TBLViewModel), "SaveLayout", bbiSaveLayout));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(ArmyProject.PL.FRM_Degree_Crud.ViewModels.Degree_TBLViewModel), "ResetLayout", bbiResetLayout));
