...
namespace ArmyProject.PL.Army_DBEntities1DataModel {
    ...
    /// <summary>
    /// IArmy_DBEntities1UnitOfWork extends the IUnitOfWork interface with repositories representing specific entities.
    /// </summary>
    public interface IArmy_DBEntities1UnitOfWork : IUnitOfWork {
        ...
        /// </summary>
		IRepository<Degree_TBL, int> Degree_TBL { get; }
        
        /// <summary>
        /// The Governorates_TBL entities repository.
        /// </summary>
		IRepository<Governorates_TBL, int> Governorates_TBL { get; }
        ...
        /// </summary>
		IRepository<RecruitingArea_TBL, int> RecruitingArea_TBL { get; }
