...
namespace ArmyProject.PL.FRM_Holiday_FULL_Crud.Views.Governorates_TBLCollectionView{
    public partial class Governorates_TBLCollectionView : XtraUserControl {
        public Governorates_TBLCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<ArmyProject.PL.FRM_Holiday_FULL_Crud.ViewModels.Governorates_TBLCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as ArmyProject.Governorates_TBL,
