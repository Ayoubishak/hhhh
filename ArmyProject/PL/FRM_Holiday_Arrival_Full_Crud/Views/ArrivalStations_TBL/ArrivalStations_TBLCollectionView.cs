...
namespace ArmyProject.PL.FRM_Holiday_Arrival_Full_Crud.Views.ArrivalStations_TBLCollectionView{
    public partial class ArrivalStations_TBLCollectionView : XtraUserControl {
        public ArrivalStations_TBLCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<ArmyProject.PL.FRM_Holiday_Arrival_Full_Crud.ViewModels.ArrivalStations_TBLCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as ArmyProject.ArrivalStations_TBL,
