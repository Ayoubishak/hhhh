...
namespace ArmyProject.PL.FRM_RecruitingAreaCrud.Views.RecruitingArea_TBLCollectionView{
    public partial class RecruitingArea_TBLCollectionView : XtraUserControl {
        public RecruitingArea_TBLCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<ArmyProject.PL.FRM_RecruitingAreaCrud.ViewModels.RecruitingArea_TBLCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as ArmyProject.RecruitingArea_TBL,
