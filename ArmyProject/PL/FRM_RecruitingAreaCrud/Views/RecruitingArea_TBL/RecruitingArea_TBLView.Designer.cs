namespace ArmyProject.PL.FRM_RecruitingAreaCrud.Views.RecruitingArea_TBLView {
    partial class RecruitingArea_TBLView {
		...
		private void InitializeComponent() {
            ...
            this.mainRibbonPageGroup.Text = "RecruitingArea_TBL Tasks";
			// 
			...
			this.dataLayoutControl1.DataSource = recruitingArea_TBLViewBindingSource;
			//
			//Create GridControls
			//
            ...
            this.mvvmContext.ViewModelType = typeof(ArmyProject.PL.FRM_RecruitingAreaCrud.ViewModels.RecruitingArea_TBLViewModel);
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(ArmyProject.PL.FRM_RecruitingAreaCrud.ViewModels.RecruitingArea_TBLViewModel), "Save", bbiSave));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(ArmyProject.PL.FRM_RecruitingAreaCrud.ViewModels.RecruitingArea_TBLViewModel), "SaveAndClose", bbiSaveAndClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(ArmyProject.PL.FRM_RecruitingAreaCrud.ViewModels.RecruitingArea_TBLViewModel), "SaveAndNew", bbiSaveAndNew));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(ArmyProject.PL.FRM_RecruitingAreaCrud.ViewModels.RecruitingArea_TBLViewModel), "Reset", bbiReset));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(ArmyProject.PL.FRM_RecruitingAreaCrud.ViewModels.RecruitingArea_TBLViewModel), "Delete", bbiDelete));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(ArmyProject.PL.FRM_RecruitingAreaCrud.ViewModels.RecruitingArea_TBLViewModel), "Close", bbiClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(ArmyProject.PL.FRM_RecruitingAreaCrud.ViewModels.RecruitingArea_TBLViewModel), "SaveLayout", bbiSaveLayout));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(ArmyProject.PL.FRM_RecruitingAreaCrud.ViewModels.RecruitingArea_TBLViewModel), "ResetLayout", bbiResetLayout));
