...
namespace ArmyProject.PL.Views.Students_TBLCollectionView{
    public partial class Students_TBLCollectionView : XtraUserControl {
        public Students_TBLCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<ArmyProject.PL.ViewModels.Students_TBLCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as ArmyProject.Students_TBL,
