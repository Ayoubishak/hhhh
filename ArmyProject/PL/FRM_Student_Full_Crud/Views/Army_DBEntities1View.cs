...
namespace ArmyProject.PL.Views.Army_DBEntities1View{
    public partial class Army_DBEntities1View : XtraUserControl {
        public Army_DBEntities1View() {
			InitializeComponent();
        ...
        void InitializeNavigation() {
            ...
            var fluentAPI = mvvmContext.OfType<ArmyProject.PL.ViewModels.Army_DBEntities1ViewModel>();
			            fluentAPI.BindCommand(navigationBarItemStudents_TBLCollectionView, (x, m) => x.Show(m), x => x.Modules[0]);
			fluentAPI.BindCommand(barButtonItemStudents_TBLCollectionView, (x, m) => x.Show(m), x => x.Modules[0]);
